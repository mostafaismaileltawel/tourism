...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="contanier text-center">
                    <a href="{{route ('hotel.create')}}" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold text-center mt-5"
                    style="width: 16rem;">
                        Add New Hotel</a>
                    </div>
                <div class="card-header">
                    <h4 class="card-title">Customize Hotels</h4>
                    @if (session('status'))
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{$item->location}}</td>
                                    <td>
                                        <a href="{{route ('hotel.edit',[$item->id])}}" class="btn btn-success">EDIT</a>
                                    </td>
                                    <td>
    ...
    {{-- <div class="contanier text-center">
        <a href="{{route ('hotel.create')}}" class="btn btn-dark py-md-2 px-md-4 font-weight-semi-bold text-center mt-5"
        style="width: 16rem;">
            New Hotel</a>
        </div>
        <br>
