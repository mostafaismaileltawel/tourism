                    ...
                    <div class="col-md-6">
                        <form action="{{route('hotel.update',[$data->id])}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="description" class="@error('description') is-invalid @enderror form-control" value="{{$data->description}}">
                                @error('description')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="location" class="@error('location') is-invalid @enderror form-control"  value="{{$data->location}}">
                                @error('location')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="rate" class="@error('rate') is-invalid @enderror form-control"  value="{{$data->rate}}">
                                @error('rate')
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" value="{{$data->name_img}}" name="name_img" placeholder="Choose file..." class="@error('file') is-invalid @enderror form-control"  value="{{$data->name_img}}">
                                @error('name_img')
