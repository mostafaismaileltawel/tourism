        ...
        <tr>
          ...
          <td>
            <div class="mb-3">
              ...
              <input type="date"  id="val3" name="arive"  min="2022-01-01"  class="@error('arive') is-invalid @enderror form-control">
            </div>
          </td></tr>
          <tr>
          <td>
